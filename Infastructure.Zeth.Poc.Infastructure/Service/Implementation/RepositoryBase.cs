...
{
    public class RepositoryBase<T> : IAsyncRepository<T> where T : InfastructureEntityBase
    {
        protected readonly InfastructureDbContext _dbContext;

        public RepositoryBase(InfastructureDbContext dbContext)
        {
